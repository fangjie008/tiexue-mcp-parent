...
<body class="body">
	<fieldset class="layui-elem-field layui-field-title">
		<legend>
			<span class="layui-breadcrumb"> <a href="javascript:;">基础信息</a> <a><cite> <c:if test="${mcpBaseInfo==null}">新增</c:if> <c:if test="${mcpBaseInfo!=null}">修改</c:if>
				</cite></a>
			</span>
		</legend>
	</fieldset>
	<form class="layui-form" method="post">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" id="name" name="name" value="${mcpBaseInfo.name}" readonly="true" autocomplete="off" placeholder="请输入合作者名称" lay-verify="name" class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
